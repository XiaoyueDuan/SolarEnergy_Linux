...
void QuasiMonteCarloRayTracer::rayTracing(SolarScene *solarScene, int heliostat_id) {
    ...
    int receiverGridCombinationIndex = receiverGridComination(receiver->getType(), grid->getGridType());
...
int QuasiMonteCarloRayTracer::receiverGridComination(int receiver_type, int grid_type) {
...
HeliostatArgument QuasiMonteCarloRayTracer::generateHeliostatArgument(SolarScene *solarScene, int heliostat_id) {
    ...
    return HeliostatArgument(d_microhelio_origins, d_microhelio_origins, d_microhelio_belonging_groups,
