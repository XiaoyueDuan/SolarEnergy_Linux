...
TEST_F(TaskLoaderFixture, loadExampleWithInvalidElements) {
    std::string invalid_path1 = "test_file/taskLoadWithInvalidElements1.txt";
    std::string invalid_path2 = "test_file/taskLoadWithInvalidElements2.txt";
    std::string invalid_path3 = "test_file/taskLoadWithInvalidElements3.txt";
...
TEST_F(TaskLoaderFixture, loadExampleWithLessThanNIndexes) {
    std::string lessThanN_path = "test_file/taskLoadWithLessThanNIndexes.txt";
...
TEST_F(TaskLoaderFixture, loadNonExistExample) {
    std::string non_exist_path = "test_file/nonExistFile.txt";
...
TEST_F(TaskLoaderFixture, loadExampleWithRepetitiveElements) {
    std::string repetitiveElements_path = "test_file/taskLoadWithRepetitiveElements.txt";
