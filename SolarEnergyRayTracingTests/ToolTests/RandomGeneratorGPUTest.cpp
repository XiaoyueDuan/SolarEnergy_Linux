...
protected:
    void SetUp() {
        ...
        checkCudaErrors(cudaMalloc((void **) &d_min_max_array, sizeof(int) * array_size));
    }
...
public:
    RandomGeneratorGPUFixture() :
            d_0_1_array(nullptr), d_min_max_array(nullptr), array_size(10) {}
